...
WebUI.setText(findTestObject('SP1/Txt_Card_Number'), '4811 1111 1111 1114')
...
WebUI.verifyElementPresent(findTestObject('SP1/Ttl_Transaction_Successful'), 0)

WebUI.click(findTestObject('SP1/Btn_Done'))

WebUI.verifyElementPresent(findTestObject('SP1/Ttl_Success_Message'), 0)
